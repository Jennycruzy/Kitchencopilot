...
export const mealPlanningAction: Action = {
...
Return ONLY JSON with 7 days, each having breakfast/lunch/dinner with ingredients_used and needs_shopping arrays.`;
    ...
    examples: [
        [
            { name: "user", content: { text: "Plan meals for this week" } },
            { name: "KitchenCopilot", content: { text: "✅ 7-day meal plan generated! Efficiency: 87%. Using spinach, chicken, and eggs first." } }
        ]
    ] as ActionExample[][],
};
